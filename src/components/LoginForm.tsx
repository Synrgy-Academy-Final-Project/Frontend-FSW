...
import { Button, Form, Input, LoginContainer, Span, Texth2, Texth3, Texth4, Texth5 } from './styles/LoginForm.styled'
    ...
    <>
      <LoginContainer>
        <Form>
          ...
          <Texth5>Email</Texth5>
          <Input type='text' value={email} onChange={handleEmailChange} placeholder='Masukkan email' />
          {errors.email && <div style={{ color: 'red', fontSize: '14px', paddingBottom: '10px' }}>{errors.email}</div>}

          <Texth5>Kata Sandi</Texth5>
          <Input type='password' value={password} onChange={handlePasswordChange} placeholder='Masukkan Kata Sandi' />
          {errors.password && (
            <div style={{ color: 'red', fontSize: '14px', paddingBottom: '5px' }}>{errors.password}</div>
          )}
